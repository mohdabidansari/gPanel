...
function GeneralSettings({ data }) {
  ...
  useEffect(() => {
    console.log("General Settings rendered");
    if (!!data) {
      setUser({
      ...
      setVerification({
        enforced: data.isEnforcedIn2Sv,
        enrolled: data.isEnrolledIn2Sv,
      });
      setCanChangePassword(data.changePasswordAtNextLogin);
    }
  }, [data]);
